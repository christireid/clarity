    ...
    <>
      ...
      <div
        className={cn(
          ...
          "glass-heavy rounded-xl shadow-2xl",
      ...
      >
        ...
        <div className="flex items-center gap-3 p-4 border-b border-white/10">
          <Command className="w-5 h-5 text-neutral-500" aria-hidden="true" />
          <input
            ref={inputRef}
            type="text"
            value={query}
            ...
            className="flex-1 bg-transparent text-sm outline-none text-neutral-900 dark:text-neutral-50 placeholder:text-neutral-500"
            aria-label="Command search"
            aria-controls="command-list"
            aria-activedescendant={`command-item-${selectedIndex}`}
          />
          <kbd className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400">
            ESC
          </kbd>
        </div>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      globalIndex === selectedIndex && "bg-neutral-100 dark:bg-neutral-800"
                    )}
                    role="option"
                    aria-selected={globalIndex === selectedIndex}
                  >
                    ...
                    <kbd className="px-2 py-1 text-xs rounded bg-neutral-200 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 font-mono">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between p-3 border-t border-white/10 text-xs text-neutral-500">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1">
              <kbd className="px-1.5 py-0.5 rounded bg-neutral-200 dark:bg-neutral-800">↑</kbd>
              <kbd className="px-1.5 py-0.5 rounded bg-neutral-200 dark:bg-neutral-800">↓</kbd>
